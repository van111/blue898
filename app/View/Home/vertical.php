...
<div id="pinContainer">
  <div class="col-3 box one panel" id="one">
    <h1>About</h1>
    <div class="row">
      <div class="col-md-4">
        <p>
  ...
  <div class="col-3 box two panel" id="two">
    <div class="col-md-10">
  ...
  <div class="col-6 box three panel center-block" id="three">
    <h1>CONTACT</h1>
    <div class="form-horizontal">
      <div class="form-group">
        ...
        <button type="button" class="btn btn-default" id="btn-send">Send</button>
      </div>
    </div>
    <!-- This content will take up 6/12 (or 1/2) of the container -->
  </div>
  <div class="col-6 box four panel" id="four">
    <p>
